...
topos = function(p)
    ...
    local Bounty = HovxrzUI:SetBeli("Bounty",game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value,Color3.fromRGB(255, 170, 0))
    ...
    task.spawn(function()
        game:GetService("RunService").RenderStepped:Connect(function()
            ...
            Bounty:Update("Bounty",game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value)
        end)
    end)
    
    local Main = HovxrzUI:Tab('6034744031',"Main")
    local Item = HovxrzUI:Tab('6031360355','Item')
    local Stats = HovxrzUI:Tab('6026647906','Stats')
    local Shop = HovxrzUI:Tab('6022668875','Shop')
    local Teleport = HovxrzUI:Tab('6034684937','Teleport')
    local Dungeon = HovxrzUI:Tab('6035153639','Dungeon')
    local Misc = HovxrzUI:Tab('6034509993','Misc')

    Item:AddSeperator([[\\ Hallow Scythe //]])
    Item:AddToggle("Auto Hallow Scythe ( ออโต้หา Hallow Scythe )",_G.AutoFarmBossHallow,function(value)
    ...
    Item:AddToggle("Auto Hallow Scythe [ Hop ] ( ออโต้หา Hallow Scythe + ย้ายเชิฟ )",_G.AutoFarmBossHallowHOP,function(value)
    ...
    Item:AddToggle("Auto Buddy Sword ( ออโต้หา Buddy Sword )",_G.AutoBuddySword,function(value)
    ...
    Item:AddToggle("Auto Buddy Sword [ Hop ] ( ออโต้หา Buddy Sword + ย้ายเชิฟ )",_G.AutoBuddySwordHOP,function(value)
        _G.AutoBuddySwordHOP = value
    end)

    Item:AddSeperator([[\\ Canvander //]])
    Item:AddToggle("Auto Canvander ( ออโต้หา Canvander )",_G.AutoCanvander,function(value)
    ...
    Item:AddToggle("Auto Canvander [ Hop ] ( Canvander + ย้ายเชิฟ )",_G.AutoCanvanderHOP,function(value)
        _G.AutoCanvanderHOP = value
    end)

    Item:AddSeperator([[\\ Dark Dagger //]])
    Item:AddToggle("Auto Dark Dagger ( ออโต้หา  Dark Dagger )",_G.AutoDarkDagger,function(value)
    ...
    Item:AddToggle("Auto Dark Dagger [ Hop ] ( ออโต้หา  Dark Dagger + ย้ายเชิฟ )",_G.AutoDarkDaggerHOP,function(value)
    ...
    Item:AddToggle("Auto Pole v1 ( ออโต้หา Pole v1 )",_G.AutoPoleVer1,function(value)
    ...
    Item:AddToggle("Auto Pole v1 [ Hop ] ( ออโต้หา Pole v1 + ย้ายเชิฟ )",_G.AutoPoleVer1HOP,function(value)
        _G.AutoPoleVer1HOP = value
    end)

    Item:AddSeperator([[\\ Saber //]])
    Item:AddToggle("Auto Saber ( ออโต้หา Saber )",_G.AutoSaber,function(value)
        _G.AutoSaber = value
        Clip = value
        if not value then
            _G.FastAttack = false
    ...
    Item:AddToggle("Auto Saber [ Hop ] ( ออโต้หา Saber + ย้ายเชิฟ )",_G.AutoSaber_Hop,function(value)
    ...
    Item:AddToggle("Auto Twin Hooks ( ออโต้หา Twin Hooks )",_G.AutoTwinHooks,function(value)
    ...
    Item:AddToggle("Auto Twin Hooks [ Hop ] ( ออโต้หา Twin Hooks + ย้ายเชิฟ )",_G.AutoTwinHooksHop,function(value)
        _G.AutoTwinHooksHop = value
    end)

    Item:AddSeperator([[\\ Serpent bow //]])
    Item:AddToggle("Auto Serpent bow ( ออโต้หา Serpent bow )",_G.AutoSerpentBow,function(value)
    ...
    Item:AddToggle("Auto Serpent bow [ Hop ] ( ออโต้หา Serpent bow + ย้ายเชิฟ )",_G.AutoSerpentBowHop,function(value)
        _G.AutoSerpentBowHop = value
    end)

    Main:AddSeperator([[\\ 📱 Normal Hub Mobile Script 📱 //]])

    local ServerTime = Main:AddLabel("Time Server ( เวลาที่ออนเชิฟ )")
    ...
    local FullMoon = Main:AddLabel("Full Moon : 000")
    ...
    Main:AddToggle("Auto Farm Level ( ออโต้ฟาร์มเลเวล )",_G.AutoFarmLevel,function(value)
    ...
    Main:AddToggle("Auto New World ( ออโต้ไปโลกสอง )",_G.AutoNewWorld,function(value)
    ...
    Main:AddToggle("Auto Thrid World ( ออโต้ไปโลกสาม )",_G.AutoThirdWorld,function(value)
    ...
    Main:AddToggle("Auto Rejoin ( ออโต้เข้าเชิฟเองถ้าโดนเตะ )",_G.AutoRejoin,function(value)
        _G.AutoRejoin = value
    end)

    if _G.FastAttackT == nil then _G.FastAttackT = true end
    Main:AddToggle("Fast Attack ( ตีเร็ว )",_G.FastAttackT,function(value)
    ...
    Main:AddToggle("Remove Notifications ( ลบเอฟเฟคข้อความ )",_G.RemoveNotifications,function(value)
    ...
    Main:AddToggle("Remove Effect Death ( ลบเอฟเฟคตอนตาย )",_G.DeathDelet,function(value)
        _G.DeathDelet = value
        if value then
            game:GetService("Players").LocalPlayer.PlayerGui.Notifications.Enabled = false
        else
    ...
    local Seclet_Weapon = Main:AddDropdown("Select Weapons ( เลือกอาวุธ )","",false,Weaponlist,function(value)
        _G.Weapon = value
    end)

    Main:AddButton("Refesh Weapon ( รีเฟรชอาวุธ )",function()
        Seclet_Weapon:Clear()
    ...
    Main:AddToggle("Auto Soul Guitar [ 20(s) ] ( ออโต้ทำโซกีต้าภายใน 20 วิ )",_G.AutoSoulGuitar ,function(value)
    ...
    Main:AddToggle("Hop Find Full Moon [ Server ] ( ย้ายเชิฟหาเชิฟ Full Moon )",_G.FindFullMoon,function(value)
        _G.FindFullMoon = value
    end)

    Main:AddSeperator([[\\ ⚙️ Gear ⚙️ //]])

    Main:AddToggle("Tween To Gear ( บินไปหาเกียร์ )",_G.TweenToGear,function(value)
    ...
    Main:AddToggle("Esp Gear ( Esp เกียร์ )",GearESP,function(value)
        GearESP = value
    ...
    Main:AddButton("Teleport To Gear ( วาปไปหาเกียร์ )",function()
        for i,v in pairs(game:GetService("Workspace").Map.MysticIsland:GetChildren()) do
            if v.Name == "Part" then
                if v.Color == Color3.fromRGB(128, 187, 219) then
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.CFrame
    ...
    Main:AddToggle("Transformed Race [ Fully ] ( ออโต้ทำภาระกิจแอนชินวัน )",_G.AutoCompleteTrail,function(value)
    ...
    Main:AddToggle("Auto Complete Race V.4 ( ออโต้ทำเผ่า )",_G.AutoCompleteTrail,function(value)
    ...
    Main:AddButton("Teleport To Temple of Time ( วาปไปที่เกาะดึงคันโยก )",function()
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(29437.5801, 15067.0342, -87.9190063, 0, 0, 1, 0, 1, -0, -1, 0, 0)
    end)

    Main:AddButton("Teleport Race v4 Door ( วาปไปประตูทำเควส )",function()
    ...
    Main:AddToggle("Auto Get [ Cursed Dual Katana ] ( ออโต้ตีบอสรวมดาบคู่ )",_G.AutoGetCDK,function(value)
        _G.AutoGetCDK = value
        Clip = value
        if not value then
            _G.FastAttack = false
    ...
    Main:AddToggle("Auto Quest [ Tushuta ] ( ออโต้ทำเควสดาบคู่ Tushuta )",_G.AutoQuestTushuta,function(value)
    ...
    Main:AddToggle("Auto Quest [ Yama ] ( ออโต้ทำเควสดาบคู่ Yama )",_G.AutoQuestYama,function(value)
    ...
    Main:AddToggle("Auto Farm Mastery [ Fruit ] ( ออโต้ฟาร์มมาสเตอร์รีผล )",_G.AutoFarmMasteryFruit,function(value)
    ...
    Main:AddToggle("Auto Farm Mastery [ Gun ] ( ออโต้ฟาร์มมาสเตอร์รีปืน )",_G.AutoFarmMasteryGun,function(value)
    ...
    Main:AddToggle("Auto Finish Dough Dungeons ( ออโต้เปิดดันโมจิ )",_G.AutoFinishDoughDungeons,function(value)
    ...
    Main:AddToggle("Auto Finish Phoenix Dungeons ( ออโต้เปิดดันฟีนิก )",_G.AutoFinishPhoenixDungeons,function(value)
    ...
    Main:AddDropdown("Select Material ( เลือก Material )","",false,Materiallist,function(value)
        _G.Material = value
    ...
    Main:AddToggle("Auto Farm Material ( ออโต้ฟาร์ม Material )",_G.AutoFarmMaterial,function(value)
    ...
    local Seclet_Boss = Main:AddDropdown("Select Boss ( เลือกบอส )","",false,Bosslist,function(value)
        _G.Boss = value
    end)

    Main:AddButton("Refesh Boss ( อัพเดทข้อมูลบอส )",function()
        Seclet_Boss:Clear()
    ...
    Main:AddToggle("Auto Farm Boss ( ออโต้ฟาร์มบอส )",_G.AutoFarmBoss,function(value)
    ...
    Main:AddToggle("Auto Farm Boss [ Hop ] ( ออโต้ฟาร์มบอส + ย้ายเชิฟ )",_G.AutoFarmBossHop,function(value)
    ...
    Main:AddToggle("Auto Farm Boss All ( ออโต้ฟาร์มบอสทั้งหมดในเกม )",_G.AutoFarmBossAll,function(value)
    ...
    Main:AddToggle("Auto Farm Observation ( ออโต้ฟาร์มฮาคิสังเกต )",_G.AutoFarmObservation,function(value)
    ...
    Main:AddToggle("Auto Farm Observation [ Hop ] ( ออโต้ฟาร์มฮาคิสังเกต + ย้ายเชิฟ )",_G.AutoFarmObservationHop,function(value)
        _G.AutoFarmObservationHop = value
    end)

    Main:AddSeperator([[\\ 🎀 Legendary Sword 🎀 //]])

    Main:AddToggle("Auto Buy Legendary Sword ( ออโต้ซื้อสามดาบโซโล )",_G.AutoBuyLegendarySword,function(value)
        _G.AutoBuyLegendarySword = value
    end)

    Main:AddToggle("Auto Buy Legendary Sword [ Hop ] ( ออโต้ซื้อสามดาบโซโล + ย้ายเชิฟ )",_G.AutoBuyLegendarySwordHop,function(value)
        _G.AutoBuyLegendarySwordHop = value
    end)

    Main:AddSeperator([[\\ 🎁 Enchament Haki 🎁 //]])

    Main:AddToggle("Auto Buy Enchament Haki  ( ออโต้ซื้อสีฮาคิ )",_G.AutoBuyEnchamentHaki,function(value)
        _G.AutoBuyEnchamentHaki = value
    end)

    Main:AddToggle("Auto Buy Enchament Haki [ Hop ] ( ออโต้ซื้อสีฮาคิ + ย้ายเชิฟ )",_G.AutoBuyEnchamentHakiHop,function(value)
    ...
    Main:AddToggle("Telport To Top Tree ( ออโต้วาปไปจุดที่สูงที่สุดในเกาะลับ )",_G.TopTree,function(value)
        _G.TopTree = value
        Clip = value
        if not value then
            topos(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
    ...
    Main:AddToggle("Teleport Advnced Fruits ( ออโต้วาปหาคนขายผลในเกาะลับ )",_G.TpADF,function(value)
        _G.TpADF = value
        Clip = value
        if not value then
            _G.FastAttack = false
    ...
    Main:AddToggle("Grab Chest Mystic Island ( ออโต้เก็บกล่องในเกาะลับ )",_G.GrabChestMystic,function(value)
    ...
    Main:AddToggle("Enabled W ( ออโต้กด W ค้าง )",_G.AutoMysticIsland,function(value)
        _G.EnabledW = value
        if not value then
            game:GetService("VirtualInputManager"):SendKeyEvent(false,tostring("W"),false,game)
        end
    end)
    Main:AddToggle("Auto Mystic Island ( ออโต้ไปเกาะลับ )",_G.AutoMysticIsland,function(value)
    ...
    Main:AddToggle("Hop Find Mystic Island [ Server ] ( ออโต้ไปเกาะลับ + ย้ายเชิฟ )",_G.HopFindIsland,function(value)
    ...
    Main:AddToggle("Auto Elite Hunter ( ออโต้อีลิตฮันเตอร์ )",_G.AutoEliteHunter,function(value)
    ...
    Main:AddToggle("Auto Elite Hunter [ Hop ] ( ออโต้อีลิตฮันเตอร์ + ย้ายเชิฟ )",_G.AutoEliteHunterHop,function(value)
    ...
    Main:AddToggle("Auto Spawn Boss [ Cake Piece ] ( ออโต้เสกบอส CakePiece )",_G.AutoSpawnBossCakePiece,function(value)
        _G.AutoSpawnBossCakePiece = value
    end)

    Main:AddToggle("Auto Cake Piece ( ออโต้ทำ Cake Piece )",_G.AutoCakePiece,function(value)
    ...
    Main:AddToggle("Auto Spin Bone ( ออโต้สุ่มโบน )",_G.AutoSpinBone,function(value)
        _G.AutoSpinBone = value
    end)
    Main:AddToggle("Auto Farm Bone ( ออโต้ฟาร์ม Bone )",_G.AutoFarmBone,function(value)
    ...
    Main:AddToggle("Auto Aura Monster ( ฟาร์มมอนรอบๆตัว )",_G.AuraMonster,function(value)
    ...
    Main:AddToggle("Auto Musketeer Hat ( ออโต้ทำหมวก Musketeer Hat )",_G.AutoMusketeerHat,function(value)
    ...
    Main:AddToggle("Auto Observation Haki v2 ( ออโต้ทำฮาคิ v2 )",_G.AutoObservationv2,function(value)
    ...
    Main:AddToggle("Auto Rainbow Haki ( ออโต้ทำฮาคิสึรุ่ง )",_G.AutoRainbowHaki,function(value)
    ...
    Main:AddToggle("Auto Get Yama ( ออโต้รับ Yama )",_G.AutoYama,function(value)
        _G.AutoYama = value
        Clip = value
        if not value then
            _G.FastAttack = false
    ...
    Main:AddToggle("Auto Get Rengoku ( ออโต้รับ Rengoku )",_G.AutoRengoku,function(value)
    ...
    Main:AddToggle("Auto Get Holy Torch ( ออโต้ทำ Holy Torch )",_G.GetTorch,function(value)
        _G.GetTorch = value
        Clip = value
        if not value then
            _G.FastAttack = false
    ...
    Stats:AddDropdown("Select Status ( เลือกสิ่งที่จะอัพ )",nil,true,Statslist,function(value)
        _G.SelectStats = value
    end)

    _G.Points = 3
    Stats:AddSlider("Point ( พอย )",1,100,_G.Points,function(value)
        _G.Points = value
    end)

    Stats:AddToggle("Auto Up Status ( ออโต้อัพสเตส )",_G.AutoUpStats,function(value)
    ...
    local Selcet_Players = Stats:AddDropdown("Select Player ( เลือกผู้เล่น )",nil,false,Playerslist,function(value)
        _G.TargetPlayerAim = value
    end)

    Stats:AddButton("Refesh Player ( อัพเดทข้อมูลผู้เล่น )",function()
    ...
    Stats:AddToggle("Spectate Players ( เปลื่ยนมุมมองเป็นผู้เล่นที่เลือก )",_G.Spectate,function(value)
        _G.Spectate = value
    ...
    Stats:AddToggle("Auto Farm Player ( ออโต้ฆ่าผู้เล่น )",_G.AutoFarmPlayer,function(value)
    ...
    Stats:AddToggle("Aimbot Player Select ( อิมบอทแบบเลือกตามที่เราเลือก )",_G.AimbotSelect,function(value)
    ...
    Stats:AddDropdown("Select Code ( เลือกโค้ด )",nil,true,CodeList,function(value)
        _G.SelectCode = value
    end)
